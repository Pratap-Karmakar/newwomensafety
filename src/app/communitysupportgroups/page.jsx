...
const CommunitySupportGroups = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-700 via-purple-800 to-purple-900 text-white p-8">
      ...
      >
        <h1 className="text-4xl font-bold mb-4">Community Support Groups</h1>
        <p className="text-lg">
      ...
      >
        <h2 className="text-3xl font-semibold mb-6">Local Support Groups</h2>
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
      >
        <h2 className="text-3xl font-semibold mb-6">Online Support Groups</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-600 rounded-lg shadow-md">
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
      >
        <h2 className="text-3xl font-semibold mb-6">Safe Spaces for Sharing</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-600 rounded-lg shadow-md">
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
      >
        <h2 className="text-3xl font-semibold mb-6">Fostering Connections</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-600 rounded-lg shadow-md">
