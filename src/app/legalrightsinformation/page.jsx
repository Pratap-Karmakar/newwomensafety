...
const LegalRightsInformation = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-700 via-purple-800 to-purple-900 text-white p-8">
      ...
      >
        <h1 className="text-4xl font-bold mb-4">Legal Rights Information</h1>
        <p className="text-lg">
      ...
      >
        <h2 className="text-3xl font-semibold mb-6">Rights During Police Encounters</h2>
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
      >
        <h2 className="text-3xl font-semibold mb-6">Tenant-Landlord Rights</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-600 rounded-lg shadow-md">
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
      >
        <h2 className="text-3xl font-semibold mb-6">Workplace Rights</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-600 rounded-lg shadow-md">
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
      >
        <h2 className="text-3xl font-semibold mb-6">Steps to Take if Your Rights are Violated</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-600 rounded-lg shadow-md">
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
      >
        <h2 className="text-3xl font-semibold mb-6">Where to Find Legal Assistance</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-600 rounded-lg shadow-md">
