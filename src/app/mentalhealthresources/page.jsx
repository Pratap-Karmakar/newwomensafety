...
const MentalHealthResources = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-700 via-purple-800 to-purple-900 text-white p-8">
      ...
      >
        <h2 className="text-3xl font-semibold mb-6">Mental Health Hotlines</h2>
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
      >
        <h2 className="text-3xl font-semibold mb-6">Therapy Options</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-600 rounded-lg shadow-md">
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
      >
        <h2 className="text-3xl font-semibold mb-6">Self-Care Strategies</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-600 rounded-lg shadow-md">
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
      >
        <h2 className="text-3xl font-semibold mb-6">Managing Stress, Anxiety, and Depression</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-600 rounded-lg shadow-md">
