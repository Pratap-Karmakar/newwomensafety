...
const SelfDefenseTechniques = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-700 to-purple-500 text-white p-8">
      <motion.div
      ...
      >
        <h1 className="text-4xl lg:text-5xl font-bold mb-4">Self-Defense Techniques</h1>
      ...
      >
        <h2 className="text-3xl lg:text-4xl font-semibold mb-6">Blocking Techniques</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-700 rounded-lg shadow-lg">
          ...
          <li className="p-4 bg-purple-600 rounded-lg shadow-lg">
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
      >
        <h2 className="text-3xl lg:text-4xl font-semibold mb-6">Striking Techniques</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-700 rounded-lg shadow-lg">
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
      >
        <h2 className="text-3xl lg:text-4xl font-semibold mb-6">Escape Moves</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-700 rounded-lg shadow-lg">
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
      >
        <h2 className="text-3xl lg:text-4xl font-semibold mb-6">Awareness Tips</h2>
        <ul className="space-y-4">
          <li className="p-4 bg-purple-700 rounded-lg shadow-lg">
